...
// Replace with your actual Calendly link once you create it at calendly.com
export const CALENDLY_URL = 'https://calendly.com/dot0x/consulta';
...
export const ui = {
  es: {
    ...
    // HERO
    'hero.title': 'Reduce Costos. Duplica Ventas. Trabaja Menos.',
    ...
    // PAIN POINTS
    'pain.title': '¿Te suena familiar esta historia?',
    'pain.1.title': 'Falta de Tiempo',
    'pain.1.desc': 'Pasas horas en tareas manuales, contestando los mismos mensajes y llenando hojas de cálculo en vez de cerrar ventas.',
    'pain.2.title': 'Clientes Perdidos',
    'pain.2.desc': 'Tu competencia aparece primero en Google y se está llevando a los clientes que te pertenecen a ti.',
    'pain.3.title': 'Costos Altos',
    'pain.3.desc': 'Contratar más personal para tareas rutinarias es caro. Tu margen de ganancia se está quedando en la nómina.',

    // SERVICES
    'services.title': 'Tu Ventaja Injusta',
    'services.subtitle': 'Soluciones "Done-For-You" diseñadas para dominar el mercado local.',
    'services.1.title': 'Agentes IA 24/7',
    'services.1.desc': 'Asistentes virtuales entrenados con toda la información de tu negocio. Contestan dudas, agendan citas y cierran ventas por ti a cualquier hora.',
    ...
    'faq.1.q': '¿Qué incluye el precio mensual? ¿Las plataformas están incluidas?',
    'faq.1.a': 'El precio mensual cubre mi trabajo: diseño, configuración, mantenimiento y soporte de tus automatizaciones o agentes IA. Las suscripciones a plataformas externas (como OpenAI, Make.com, etc.) son un costo adicional que se paga directamente a esas plataformas. Te explico exactamente cuánto cuestan antes de empezar — sin sorpresas. En muchos casos uso herramientas open-source que corren en servidores propios para reducir ese costo al mínimo.',
    'faq.2.q': '¿En cuánto tiempo veré resultados con el SEO?',
    'faq.2.a': 'Para SEO Local en Puerto Rico, la mayoría de proyectos comienzan a mostrar resultados medibles entre 30-60 días. El posicionamiento completo se consolida entre 3-6 meses. Recibirás reportes mensuales con métricas claras.',
    'faq.3.q': '¿Necesito conocimientos técnicos para usar tus servicios?',
    'faq.3.a': 'Para nada. Yo manejo todo el proceso técnico de principio a fin. Tú solo apruebas, revisas y recoges los resultados. Esto es "Done-For-You" — instalado, configurado y funcionando sin que tengas que tocar código.',
    'faq.4.q': '¿Qué tipo de negocios se benefician más?',
    'faq.4.a': 'Negocios locales en Puerto Rico con operaciones repetitivas: clínicas, restaurantes, bienes raíces, talleres, spas, contadores, consultores. Si tu equipo contesta las mismas preguntas todos los días o si pierdes clientes porque tu negocio no aparece en Google — esto es para ti.',
    'faq.5.q': '¿Qué pasa si no veo resultados?',
    'faq.5.a': 'Trabajo con total transparencia. Si en los primeros 30 días no hay progreso medible, ajusto la estrategia sin costo adicional. No cobro por trabajo que no genera valor.',
  ...
  en: {
    ...
    // HERO
    'hero.title': 'Cut Costs. Double Sales. Work Less.',
    ...
    'pain.1.title': 'Lack of Time',
    'pain.1.desc': 'You spend hours on manual tasks, answering the same messages, and filling out spreadsheets instead of closing deals.',
    'pain.2.title': 'Lost Clients',
    'pain.2.desc': 'Your competition ranks first on Google and is taking the local customers that belong to you.',
    'pain.3.title': 'High Overhead',
    'pain.3.desc': 'Hiring more staff for routine tasks is expensive. Your profit margins are being eaten by payroll.',

    // SERVICES
    'services.title': 'Your Unfair Advantage',
    'services.subtitle': '"Done-For-You" solutions designed to dominate the local market.',
    'services.1.title': '24/7 AI Agents',
    'services.1.desc': 'Virtual assistants trained on your entire business. They answer questions, book appointments, and close sales for you at any hour.',
    ...
    'faq.1.q': 'What does the monthly price include? Are platforms included?',
    'faq.1.a': 'The monthly fee covers my work: design, configuration, maintenance, and support for your automations or AI agents. Subscriptions to external platforms (like OpenAI, Make.com, etc.) are an additional cost paid directly to those platforms. I explain exactly what those cost before we start — no surprises. In many cases I use open-source tools running on private servers to keep that cost minimal.',
    'faq.2.q': 'How soon will I see results from SEO?',
    'faq.2.a': 'For Local SEO in Puerto Rico, most projects start showing measurable results within 30-60 days. Full ranking consolidates between 3-6 months. You\'ll receive monthly reports with clear metrics.',
    'faq.3.q': 'Do I need technical knowledge to use your services?',
    'faq.3.a': 'Not at all. I handle the entire technical process from start to finish. You just approve, review, and collect the results. This is "Done-For-You" — installed, configured, and running without you touching any code.',
    'faq.4.q': 'What type of businesses benefit most?',
    'faq.4.a': 'Local businesses in Puerto Rico with repetitive operations: clinics, restaurants, real estate, shops, spas, accountants, consultants. If your team answers the same questions every day or you\'re losing clients because your business doesn\'t show up on Google — this is for you.',
    'faq.5.q': 'What if I don\'t see results?',
    'faq.5.a': 'I work with full transparency. If there\'s no measurable progress in the first 30 days, I adjust the strategy at no extra cost. I don\'t charge for work that doesn\'t generate value.',
